...
const domain = import.meta.env.VITE_MINEMAP_DOMAIN || '//111.50.130.153:10873'
const serverDomain = import.meta.env.VITE_MINEMAP_SERVER_DOMAIN || 'http://111.50.130.153:10873/'
const cdn = import.meta.env.VITE_MINEMAP_CDN || 'http://111.50.130.153:10873/minemapapi/minemap-CDN'

window.minemap.domainUrl = domain
window.minemap.dataDomainUrl = domain
window.minemap.serverDomainUrl = serverDomain
window.minemap.spriteUrl = `${serverDomain}minemapapi/v4.0.0/sprite/sprite`
window.minemap.serviceUrl = `${serverDomain}service`
window.minemapCDN = cdn
...
export const useMap = (options = {}) => {
  ...
  const initMap = () => {
    ...
    const defaultZoom = Number(import.meta.env.VITE_DEFAULT_ZOOM) || 8
